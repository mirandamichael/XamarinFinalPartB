package collegeassignment.androidapplicationfinal;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, md5cc23b402e6b7b74669a57c1ddd768504.MainActivity.class);
